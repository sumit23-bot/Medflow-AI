 ...
 * Pricing.jsx
 * Route: /pricing
 * Purpose: Affordable for free rural dispensaries (₹0) to multi-branch hospital chains
 */
    ...
    <div className="space-y-6 max-w-5xl mx-auto py-10 px-4">
      <div className="border-b border-gray-300 pb-4">
        <div className="flex items-center gap-2 mb-2">
          <Badge variant="tag">/pricing</Badge>
        ...
        <h1 className="text-2xl md:text-3xl font-serif font-bold text-ink-950 tracking-tight">
          Tiered Pricing: Free Community to Business
        </h1>
        <p className="text-sm text-gray-600 font-sans mt-1">
          Affordable for free rural dispensaries (₹0) to multi-branch hospital chains
        </p>
      </div>

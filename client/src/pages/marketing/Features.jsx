 ...
 * Features.jsx
 * Route: /features
 * Purpose: Comprehensive feature breakdown for primary healthcare providers
 */
    ...
    <div className="space-y-6 max-w-5xl mx-auto py-10 px-4">
      <div className="border-b border-gray-300 pb-4">
        <div className="flex items-center gap-2 mb-2">
          <Badge variant="tag">/features</Badge>
        ...
        <p className="text-sm text-gray-600 font-sans mt-1">
          Comprehensive feature breakdown for primary healthcare providers
        </p>
      </div>

 ...
 * Home.jsx
 * Route: /
 * Purpose: Official landing: mission statement, high-level value prop, CTA to demo/pricing
 */
    ...
    <div className="space-y-6 max-w-5xl mx-auto py-10 px-4">
      <div className="border-b border-gray-300 pb-4">
        ...
        <h1 className="text-2xl md:text-3xl font-serif font-bold text-ink-950 tracking-tight">
          MedFlow AI — Rural Clinic Triage & Digitization Platform
        </h1>
        <p className="text-sm text-gray-600 font-sans mt-1">
          Official landing: mission statement, high-level value prop, CTA to demo/pricing
        </p>
      </div>

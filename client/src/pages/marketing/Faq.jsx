 ...
 * Faq.jsx
 * Route: /faq
 * Purpose: Official answers regarding security, voice recognition in regional languages, and offline capability
 */
    ...
    <div className="space-y-6 max-w-5xl mx-auto py-10 px-4">
      <div className="border-b border-gray-300 pb-4">
        ...
        <p className="text-sm text-gray-600 font-sans mt-1">
          Official answers regarding security, voice recognition in regional languages, and offline capability
        </p>
      </div>

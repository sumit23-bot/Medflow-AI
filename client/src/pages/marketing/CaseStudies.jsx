 ...
 * CaseStudies.jsx
 * Route: /case-studies
 * Purpose: Real clinic results, consult-time reduction metrics, and patient satisfaction
 */
    ...
    <div className="space-y-6 max-w-5xl mx-auto py-10 px-4">
      <div className="border-b border-gray-300 pb-4">
        <div className="flex items-center gap-2 mb-2">
          <Badge variant="tag">/case-studies</Badge>
        ...
        <h1 className="text-2xl md:text-3xl font-serif font-bold text-ink-950 tracking-tight">
          Clinical Case Studies & Field Results
        </h1>
        <p className="text-sm text-gray-600 font-sans mt-1">
          Real clinic results, consult-time reduction metrics, and patient satisfaction
        </p>
      </div>

 ...
 * Solution.jsx
 * Route: /solution
 * Purpose: Kiosk -> Doctor -> Counter -> Record flow explained step by step
 */
    ...
    <div className="space-y-6 max-w-5xl mx-auto py-10 px-4">
      <div className="border-b border-gray-300 pb-4">
        <div className="flex items-center gap-2 mb-2">
          <Badge variant="tag">/solution</Badge>
        ...
        <h1 className="text-2xl md:text-3xl font-serif font-bold text-ink-950 tracking-tight">
          The Solution: 4-Step Paperless Clinic Loop
        </h1>
        <p className="text-sm text-gray-600 font-sans mt-1">
          Kiosk &rarr; Doctor &rarr; Counter &rarr; Record flow explained step by step
        </p>
      </div>

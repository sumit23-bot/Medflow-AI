 ...
 * Problem.jsx
 * Route: /problem
 * Purpose: Ground-reality story and stats: long token lines, doctor fatigue, paper register loss
 */
    ...
    <div className="space-y-6 max-w-5xl mx-auto py-10 px-4">
      <div className="border-b border-gray-300 pb-4">
        <div className="flex items-center gap-2 mb-2">
          <Badge variant="tag">/problem</Badge>
        ...
        <h1 className="text-2xl md:text-3xl font-serif font-bold text-ink-950 tracking-tight">
          The Problem: Overcrowded Clinics & Record Loss
        </h1>
        <p className="text-sm text-gray-600 font-sans mt-1">
          Ground-reality story and stats: long token lines, doctor fatigue, paper register loss
        </p>
      </div>

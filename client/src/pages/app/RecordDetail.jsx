...
/**
 * RecordDetail.jsx
 * Route: /app/records/:patientId
 * Purpose: Printable chronological history of patient diagnoses and medicines (B9)
 */
    ...
    <div className="space-y-6 max-w-5xl mx-auto py-2">
      <div className="border-b border-gray-300 pb-4">
        <div className="flex items-center gap-2 mb-2">
          <Badge variant="tag">/app/records/:patientId</Badge>
        ...
        <p className="text-sm text-gray-600 font-sans mt-1">
          Printable chronological history of patient diagnoses and medicines (B9)
        </p>
      </div>
      ...
      >
        <div className="bg-gray-50 border border-gray-200 p-6 rounded text-center space-y-3">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-gray-300 rounded text-xs font-mono text-gray-600">
            <span>Component:</span>
            <strong>RecordDetail.jsx</strong>
          </div>
        </div>
      </Card>
    </div>

 ...
 * Kiosk.jsx
 * Route: /app/kiosk
 * Purpose: Voice/text symptom intake and live token issuance (B1)
 */
    ...
    <div className="space-y-6 max-w-5xl mx-auto py-2">
      <div className="border-b border-gray-300 pb-4">
        <div className="flex items-center gap-2 mb-2">
          <Badge variant="tag">/app/kiosk</Badge>
        ...
        <h1 className="text-2xl md:text-3xl font-serif font-bold text-ink-950 tracking-tight">
          Patient Walk-In Kiosk: Get Token
        </h1>
        <p className="text-sm text-gray-600 font-sans mt-1">
          Voice/text symptom intake and live token issuance (B1)
        </p>
      </div>
